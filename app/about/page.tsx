...
export default function About() { return <>
  ...
  <Section><div className="split"><PlaceholderImage id="about/founder" className="founder-portrait"/><div><Heading eyebrow="Our Leadership" title="Dr. LaToya Pryce"/><p className="eyebrow">Founder</p><p>Be Inspired NJ is guided by leadership committed to creating opportunities for women, strengthening communities, and turning inspiration into meaningful action.</p><Button href="/our-leadership">Meet the Founder</Button></div></div></Section>
