...
export default function Home() { return <>
  ...
  <Section><div className="split who-section"><div className="portrait-wrap"><PlaceholderImage id="home/who-we-are" loading="eager"/><span className="portrait-note">Possibility begins<br/><em>with connection.</em></span></div><div><Heading eyebrow="Who We Are" title="Inspiration can open the door. Opportunity creates lasting change."/><Copy name="who"/><Button href="/about" variant="ghost">Get to Know Be Inspired NJ</Button></div></div></Section>
  ...
  <Section tone="dark"><div className="split"><PlaceholderImage id="home/impact" loading="eager"/><div><Heading eyebrow="Our Impact" title="Impact Begins With Opportunity"/><Copy name="impact"/><Button href="/about#impact-goals">Explore Our Impact</Button></div></div></Section>
