...
export const images: ImageSlot[] = [
  ...
  { ...slot("about/tatiana", "1/1", "Tatiana Lopez, Board Member of Be Inspired NJ", "circle"), path: "/ImagesOfBeInspired/Tatiana Lopez_RGB.jpg", available: true },
  { ...slot("about/angie", "1/1", "Andreau ‘Angie’ Todd, Board Member of Be Inspired NJ", "circle"), path: "/images/Screenshot 2026-09-16 005016.png", available: true },
  ...
  { ...slot("leadership/latoya", "3/2", "Portrait of Dr. LaToya Pryce, Founder and President of Be Inspired NJ"), path: "/ImagesOfBeInspired/Headshot2.jpg", available: true },
  ...Array.from({ length: 3 }, (_, i) => slot(`leadership/coming-soon-${i + 1}`, "1/1", "Board member portrait — coming soon")),
  { ...slot("board/tatiana", "3/4", "Portrait of Tatiana Lopez"), path: "/ImagesOfBeInspired/Tatiana Lopez_RGB.jpg", available: true },
  { ...slot("board/angie", "3/4", "Portrait of Andreau ‘Angie’ Todd"), path: "/images/Screenshot 2026-09-16 005016.png", available: true },
